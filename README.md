...
# Raffle Already Deployed On Sepolia TestNet 
  - Winner in 60 seconds ``` 0x95395422797434Fec90ae62AdD9a74A5B058abA3```

 - Winner in 30 Seconds ```0xbf5adc32545fdb6c441770d9166bdabf0d596247```
...
```
git clone https://github.com/Bhavik-punmiya/SmartContract-Lottery-Foundry
cd SmartContract-Lottery-Foundry
forge build
```
